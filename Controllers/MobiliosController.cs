...
namespace armadieti2.Controllers
{
    public class MobiliosController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["Numerochiave"] = new SelectList(_context.Chiaves, "Numerochiave", "Numerochiave");
            ViewData["Statomobilio"] = new SelectList(_context.Statomobilios, "Statomobilio1", "Statomobilio1");
            ViewData["Tipomobilio"] = new SelectList(_context.Tipomobilios, "Tipomobilio1", "Tipomobilio1");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Idmobilio,Numero,Idlocation,Tipomobilio,Numerochiave,Statomobilio")] Mobilio mobilio)
        {
            ...
            ViewData["Idlocation"] = new SelectList(_context.Locations, "Idlocation", "Idlocation", mobilio.Idlocation);
            ViewData["Numerochiave"] = new SelectList(_context.Chiaves, "Numerochiave", "Numerochiave", mobilio.Numerochiave);
            ViewData["Statomobilio"] = new SelectList(_context.Statomobilios, "Statomobilio1", "Statomobilio1", mobilio.Statomobilio);
            ViewData["Tipomobilio"] = new SelectList(_context.Tipomobilios, "Tipomobilio1", "Tipomobilio1", mobilio.Tipomobilio);
            return View(mobilio);
        }
