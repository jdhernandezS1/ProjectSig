    ...
    public class StatomobiliosController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var statomobilio = await _context.Statomobilios
                .FirstOrDefaultAsync(m => m.Statomobilio1 == id);
        ...
        public async Task<IActionResult> Create([Bind("Statomobilio1")] Statomobilio statomobilio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Statomobilio1")] Statomobilio statomobilio)
        {
            if (id != statomobilio.Statomobilio1)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!StatomobilioExists(statomobilio.Statomobilio1))
                    {
                        return NotFound();
                    }
                    else
        ...
        private bool StatomobilioExists(string id)
        {
            return _context.Statomobilios.Any(e => e.Statomobilio1 == id);
        }
    }
}
