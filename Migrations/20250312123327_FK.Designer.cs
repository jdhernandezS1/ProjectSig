            ...
            modelBuilder.Entity("armadieti2.Models.UtenteModel", b =>
                {
                    ...
                    b.Property<int>("DipartimentoModelIdDipartimento")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TipoUtenteModelIdTipoUtente")
                        .HasColumnType("integer");

                    b.HasKey("IdUtente");

                    b.HasIndex("DipartimentoModelIdDipartimento");

                    b.HasIndex("TipoUtenteModelIdTipoUtente");
            ...
            modelBuilder.Entity("armadieti2.Models.UtenteModel", b =>
                {
                    b.HasOne("armadieti2.Models.DipartimentoModel", "DipartimentoModel")
                        .WithMany()
                        .HasForeignKey("DipartimentoModelIdDipartimento")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("armadieti2.Models.TipoUtenteModel", "TipoUtenteModel")
                        .WithMany()
                        .HasForeignKey("TipoUtenteModelIdTipoUtente")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
